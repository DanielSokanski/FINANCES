...
public:
    YourBudget
    (string FileNameWithUsers, string fileNameWithIncomes, string fileNameWithExpences) :
    userManager(FileNameWithUsers), FILE_NAME_WITH_INCOMES(fileNameWithIncomes), FILE_NAME_WITH_EXPENCES(fileNameWithExpences)
    {
    incomeManager = NULL;
    expenceManager = NULL;
    };
